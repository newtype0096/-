...
class Ui_Dialog(object):
    ...
    def pushButton_SaveImage_Clicked(self):
        ...
        if self.dir != '':
            ...
            try:
                ...
                self.textBrowser.append(self.dir + ' 경로에 모든 이미지 다운로드 완료')
            except:
                # pass
    ...
    # function
    # def SaveImage(self, url1, url2):
    #     self.SaveImage1(url1)
    #      self.SaveImage2(url2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_15.setText(_translate('Dialog', '1.0.1 | 앰아 (M-AHHH)'))
